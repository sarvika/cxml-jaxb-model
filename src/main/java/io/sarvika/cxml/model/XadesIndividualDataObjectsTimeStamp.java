...
public class XadesIndividualDataObjectsTimeStamp {
  ...
  @XmlElements({
      @XmlElement(name = "xades:EncapsulatedTimeStamp",
          required = true,
          type = XadesEncapsulatedTimeStamp.class),
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link XadesInclude
   * }
   * 
   * 
   */
   ...
   * 
   * @return possible object is {@link DsCanonicalizationMethod }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link DsCanonicalizationMethod }
   * 
   */
   ...
   * Therefore any modification you make to the returned list will be present
   * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
   * for the xadesEncapsulatedTimeStampOrXadesXMLTimeStamp property.
   * 
   * <p>
   * For example, to add a new item, do as follows:
   * 
   ...
   * {@link XadesEncapsulatedTimeStamp } {@link XadesXMLTimeStamp }
   * 
   * 
   */
