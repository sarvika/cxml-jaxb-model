...
public class XadesUnsignedSignatureProperties {
  ...
  protected String id;
  @XmlElements({
      @XmlElement(name = "xades:CounterSignature",
          required = true,
          type = XadesCounterSignature.class),
      @XmlElement(name = "xades:SignatureTimeStamp",
          required = true,
          type = XadesSignatureTimeStamp.class),
      @XmlElement(name = "xades:CompleteCertificateRefs",
          required = true,
          type = XadesCompleteCertificateRefs.class),
      @XmlElement(name = "xades:CompleteRevocationRefs",
          required = true,
          type = XadesCompleteRevocationRefs.class),
      @XmlElement(name = "xades:AttributeCertificateRefs",
          required = true,
          type = XadesAttributeCertificateRefs.class),
      @XmlElement(name = "xades:AttributeRevocationRefs",
          required = true,
          type = XadesAttributeRevocationRefs.class),
      @XmlElement(name = "xades:SigAndRefsTimeStamp",
          required = true,
          type = XadesSigAndRefsTimeStamp.class),
      @XmlElement(name = "xades:RefsOnlyTimeStamp",
          required = true,
          type = XadesRefsOnlyTimeStamp.class),
      @XmlElement(name = "xades:CertificateValues",
          required = true,
          type = XadesCertificateValues.class),
      @XmlElement(name = "xades:RevocationValues",
          required = true,
          type = XadesRevocationValues.class),
      @XmlElement(name = "xades:AttrAuthoritiesCertValues",
          required = true,
          type = XadesAttrAuthoritiesCertValues.class),
      @XmlElement(name = "xades:AttributeRevocationValues",
          required = true,
          type = XadesAttributeRevocationValues.class),
      @XmlElement(name = "xades:ArchiveTimeStamp",
          required = true,
          type = XadesArchiveTimeStamp.class)
  })
   ...
   * {@link XadesCounterSignature } {@link XadesSignatureTimeStamp }
   * {@link XadesCompleteCertificateRefs } {@link XadesCompleteRevocationRefs }
   * {@link XadesAttributeCertificateRefs } {@link XadesAttributeRevocationRefs }
   * {@link XadesSigAndRefsTimeStamp } {@link XadesRefsOnlyTimeStamp }
   * {@link XadesCertificateValues } {@link XadesRevocationValues }
   * {@link XadesAttrAuthoritiesCertValues } {@link XadesAttributeRevocationValues
