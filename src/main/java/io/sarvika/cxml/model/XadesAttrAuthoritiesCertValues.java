...
public class XadesAttrAuthoritiesCertValues {
  ...
  protected String id;
  @XmlElements({
      @XmlElement(name = "xades:EncapsulatedX509Certificate",
          type = XadesEncapsulatedX509Certificate.class),
  ...
  /**
   * Gets the value of the xadesEncapsulatedX509CertificateOrXadesOtherCertificate
   * property.
   * 
   * <p>
   ...
   * for the xadesEncapsulatedX509CertificateOrXadesOtherCertificate property.
   * 
   * <p>
   ...
   * {@link XadesEncapsulatedX509Certificate } {@link XadesOtherCertificate }
   * 
   * 
   */
