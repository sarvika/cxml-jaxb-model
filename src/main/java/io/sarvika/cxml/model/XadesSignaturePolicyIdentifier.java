...
public class XadesSignaturePolicyIdentifier {
  ...
  @XmlElements({
      @XmlElement(name = "xades:SignaturePolicyId",
          required = true,
          type = XadesSignaturePolicyId.class),
      @XmlElement(name = "xades:SignaturePolicyImplied",
          required = true,
          type = XadesSignaturePolicyImplied.class)
  })
  protected List<Object> xadesSignaturePolicyIdOrXadesSignaturePolicyImplied;

  /**
   * Gets the value of the xadesSignaturePolicyIdOrXadesSignaturePolicyImplied
   * property.
   * 
   * <p>
   ...
   * for the xadesSignaturePolicyIdOrXadesSignaturePolicyImplied property.
   * 
   * <p>
   ...
   * {@link XadesSignaturePolicyId } {@link XadesSignaturePolicyImplied }
   * 
   * 
   */
