...
public class TaxInformation {
   ...
   * 
   * @return possible object is {@link LegalName }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link LegalName }
   * 
   */
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link TaxID }
   * 
   * 
   */
