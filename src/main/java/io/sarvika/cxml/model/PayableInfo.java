...
public class PayableInfo {
  ...
  @XmlElements({
      ...
      @XmlElement(name = "PayableMasterAgreementInfo",
          required = true,
          type = PayableMasterAgreementInfo.class)
  })
  protected List<Object> payableInvoiceInfoOrPayableOrderInfoOrPayableMasterAgreementInfo;

  /**
   * Gets the value of the
   * payableInvoiceInfoOrPayableOrderInfoOrPayableMasterAgreementInfo property.
   * 
   * <p>
   * This accessor method returns a reference to the live list, not a snapshot.
   * Therefore any modification you make to the returned list will be present
   * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
   * for the payableInvoiceInfoOrPayableOrderInfoOrPayableMasterAgreementInfo
   * property.
   * 
   * <p>
   ...
   * {@link PayableInvoiceInfo } {@link PayableOrderInfo }
