...
public class RailDetail {
   ...
   * 
   * @return possible object is {@link TripType }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link TripType }
   * 
   */
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link RailLeg }
   * 
   * 
   */
