...
public class Person {
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link PersonRole }
   * 
   * 
   */
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link IdReference }
   * 
   * 
   */
