...
public class SpendDetail {
  ...
  /**
   * Gets the value of the travelDetailOrFeeDetailOrLaborDetailOrExtrinsic
   * property.
   * 
   * <p>
   ...
   * for the travelDetailOrFeeDetailOrLaborDetailOrExtrinsic property.
   * 
   * <p>
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link TravelDetail
   * } {@link FeeDetail } {@link LaborDetail } {@link Extrinsic }
   * 
   * 
   */
