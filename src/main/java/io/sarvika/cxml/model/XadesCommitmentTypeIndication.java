...
public class XadesCommitmentTypeIndication {
  ...
  @XmlElements({
      @XmlElement(name = "xades:ObjectReference",
          required = true,
          type = XadesObjectReference.class),
      @XmlElement(name = "xades:AllSignedDataObjects",
          required = true,
          type = XadesAllSignedDataObjects.class)
  })
   ...
   * 
   * @return possible object is {@link XadesCommitmentTypeId }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link XadesCommitmentTypeId }
   * 
   */
   ...
   * for the xadesObjectReferenceOrXadesAllSignedDataObjects property.
   * 
   * <p>
   ...
   * {@link XadesObjectReference } {@link XadesAllSignedDataObjects }
   * 
   * 
   */
   ...
   * 
   * @return possible object is {@link XadesCommitmentTypeQualifiers }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link XadesCommitmentTypeQualifiers }
   * 
   */
