...
public class Index {
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link SearchGroup }
   * 
   * 
   */
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link IndexItem }
   * 
   * 
   */
