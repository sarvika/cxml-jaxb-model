...
public class DsSignedInfo {
   ...
   * 
   * @return possible object is {@link DsSignatureMethod }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link DsSignatureMethod }
   * 
   */
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link DsReference }
   * 
   * 
   */
